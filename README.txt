...
Scripts are written in Julia, and use a Manifest.toml and Project.toml for package management. Due to significant changes to the Agents.jl package, these scripts will only run with Agents.jl version 5.12 and Julia version
