...
tolerances = [0.5,0.1,0.15,0.20,0.25,0.30,0.35,0.4,0.45,0.5,0.55,0.6,0.65,0.7,0.75,0.8,0.85,0.9,0.95]
...
for t in tolerances
    ...
    results = Matrix{Float32}(undef,entries,6)
    for i in 1:100
        run_id = i
        results[idx,1] = idx
        ...
        global seg_tolerance_1 = tolerance
        global seg_tolerance_2 = tolerance
        global happy_agents_2 = 0
        global similarity_ratio_sum_2 = 0
        global convergence = 1000
        ...
        function initialize(; 
            ...
            for n in 1:total_agents
                agent = SchellingAgent(n, (1, 1), seg_tolerance_1, true, n < total_agents / 2 ? 1 : 2)
            ...
            for agent in model.agents
                ...
                similarity_ratio_sum_1 = similarity_ratio_sum_1 + (count_neighbors_same_group/count_neighbours)
        ...
        function agent_step!(agent, model)
            ...
            while count_neighbours ≤ 40 #each node should have at least 50 friends, this can be disrupted by incoming links being broken
                friend = randomExcluded(1,total_agents,which_agent)    
